        ...
        vec![Function {
            ...
            body: vec![Block {
                ...
                ins: vec![
                    ...
                    TIR::IConst(4, 16, TirType::I64),
                    TIR::CallExternFunction(
                        5,
                        Box::new("toy_malloc_struct".to_string()),
                        vec![
                            SSAValue {
                                val: 4,
                                ty: Some(TirType::I64),
                ...
                body: vec![
                    ...
                    Block {
                        ...
                        ins: vec![
                            ...
                            TIR::JumpBlockUnCond(48, 2),
                        ],
                    },
                    Block {
                        id: 4,
                        ins: vec![
                            TIR::IConst(49, 4, TirType::I64),
                            TIR::IConst(50, 1, TirType::I64),
                            TIR::CallExternFunction(
                                51,
                                Box::new("toy_println".to_string()),
                                vec![
...
#[test]
fn test_tirgen_unused_float_lit() {
    setup_tir!(ir, "285974.585;");
    compare_tir(
        "unused_float_lit",
        ir,
        vec![Function {
            ...
            body: vec![Block {
                id: 0,
                ins: vec![
                    TIR::FConst(0, 285974.585, TirType::F64),
                    TIR::IConst(1, 0, TirType::I64),
                    TIR::Ret(
                        2,
                        SSAValue {
